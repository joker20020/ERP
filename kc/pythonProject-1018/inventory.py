...
if __name__ == "__main__":
    ...
    # 添加商品
    manager.add_product("左壳体1", 100,  101)
    manager.add_product("右壳体1", 100,  102)
    manager.add_product("支架1", 100, 103)
    manager.add_product("密封圈2", 100, 104)
    manager.add_product("活塞1", 100, 105)
    manager.add_product("塑料套1", 100,  106)
    manager.add_product("橡胶套1", 100,  107)
    manager.add_product("放气螺栓1", 100, 108)
    manager.add_product("防尘帽1", 100, 109)
    manager.add_product("内六角螺栓1", 100, 110)
    manager.add_product("摩擦片2", 100,  111)
    manager.add_product("隔垫1", 100,  112)
    manager.add_product("开口导向套管2", 100, 113)
