...
class Ui_Admin(object):
    def setupUi(self, Admin):
        ...
        self.formLayout_2.setWidget(0, QFormLayout.FieldRole, self.wokerName)
        ...
        self.formLayout_2.setWidget(1, QFormLayout.FieldRole, self.workerAge_2)
        ...
        self.formLayout_2.setWidget(6, QFormLayout.LabelRole, self.workerCharacterL)

        self.workerCharacter = QComboBox(Admin)
        self.workerCharacter.setObjectName(u"workerCharacter")

        self.formLayout_2.setWidget(6, QFormLayout.FieldRole, self.workerCharacter)
        ...
        self.characterList = QListView(Admin)
