...
class Ui_AddWorker(object):
    def setupUi(self, AddWorker):
        ...
        self.workerNameL = BodyLabel(AddWorker)
        ...
        self.workerPasswordL = BodyLabel(AddWorker)
        ...
        self.workerPassword = LineEdit(AddWorker)
        ...
        self.workerCharacterL = BodyLabel(AddWorker)
        ...
        self.workerCharacter = ComboBox(AddWorker)
        ...
        self.ok = PrimaryPushButton(AddWorker)
        self.ok.setObjectName(u"ok")

        self.formLayout_2.setWidget(8, QFormLayout.FieldRole, self.ok)

        self.workerUserName = LineEdit(AddWorker)
